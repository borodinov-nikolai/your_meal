...
const Test = () => {
  ...
  return (
    <div className={"relative h-[500px] w-screen "}>
      <div
        data-tid="label"
        className={"absolute left-[10px] top-[10px] z-10 text-white"}
      >
        Temp: {data[data.length - 1]["temp"]} c
      </div>
      <div
        data-tid="label"
        className={"absolute left-[10px] top-[40px] z-10 text-white"}
      >
        Hesh: {data[data.length - 1]["hash"]}
      </div>
