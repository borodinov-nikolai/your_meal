  ...
  return (
    <div data-tid="footer" className="bg-white">
      <div
        data-tid="container"
        className={
          "container pb-[26px] pt-6 sm:pt-10 lg:pb-[39px] lg:pt-[52px]"
        }
      >
        <div
          data-tid="flex-wrapper"
        ...
        >
          ...
          ></Image>
          <div
            data-tid="footer_block"
            className={
              "flex flex-col sm:flex-row sm:gap-[177px] lg:gap-[50px] xl:mr-[136px] xl:gap-[126px]"
            }
          >
            <div data-tid="call" className="mt-6 md:mt-[36px] lg:mt-0">
              <h3
                data-tid="call_title"
                className={"text-[18px] leading-none lg:text-2xl"}
              >
                Номер для заказа
              </h3>
              <div
                data-tid="number"
                className={"mt-2 flex items-center gap-2 lg:mt-6"}
              >
                <Image
                  className={" h-6 w-6"}
                  src={icon_call}
            ...
            <div data-tid="social" className={"mt-6 lg:mt-0"}>
              <h3
                data-tid="social_title"
                className={"text-[18px] leading-none lg:text-2xl"}
              >
                Мы в соцсетях
              </h3>
              <div
                data-tid="social_icons"
                className={"mt-2 flex gap-4 lg:mt-[22px]"}
              >
                <Image
        ...
        <div data-tid="copyright" className={"mt-[34px]"}>
          ...
          <p className={"mt-1 text-xs leading-4"}>Design: Anastasia Ilina </p>
        </div>
      </div>
    </div>
  );
