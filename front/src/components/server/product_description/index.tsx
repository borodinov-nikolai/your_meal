...
const Product_description = () => {
    ...
    return (
        <div data-tid='product_description' className={'w-screen lg:pt-6 lg:w-[684px] lg:h-[432px] sm:w-[524px] lg:px-6 sm:rounded-3xl sm:h-[324px] h-screen px-[10px] sm:px-4 pt-[32px] sm:pt-4 bg-white'} >
          <h1 data-tid='product_description__title' className={' text-[28px] lg:text-[40px] lg:leading-[48px] font-semibold leading-[34px]'}>Мясная бомба</h1>
          ...
          <Image data-tid='product_description__description-image' className={'w-300 h-232 lg:w-[276px] lg:h-[220px] sm:w-[226px] sm:h-[180px] self-center '} src={image_product} width={300} height={232} alt='product image'/>
            <div data-tid='product_descroption__description-text' className={' mt-4 sm:mt-0 '} > 
              <p className={'text-xs leading-[15.6px] lg:text-base lg:leading-[20.8px]'} >Супер мясное наслаждение! Большая рубленая котлета из свежего говяжего мяса покорит вас своей сочностью, а хрустящие листья салата добавят свежести.</p>
            ...
            <p className={'mt-1 lg:text-xs lg:leading-[15.6px] text-[10px] leading-[14px] text-[#B1B1B1]'} >520г, ккал 430</p>
            </div>
          </div>
          <div data-tid='product_description__footer' className={'mt-[98px] lg:mt-10 sm:mt-6 flex flex-col sm:flex-row sm:justify-between '} >
            ...
            <div data-tid="product_description__price" className={' sm:place-self-center mt-4 lg:text-2xl lg:leading-[31.2px] sm:mt-0 place-self-end leading-[20px] font-semibold'} >689₽</div>
          </div>
        </div>
    )
}
